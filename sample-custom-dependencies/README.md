...
1. Locate (or create) the `custom-dependencies/composer.json` file in the project.
...
1. Locate (or create) the `custom-dependencies/patches.custom.json` file in the project.
