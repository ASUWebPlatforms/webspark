...
class AsuDegreeRfiRfiBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    $props['variant'] = $config['asu_degree_rfi_variant'] ?? $global_config->get('asu_degree_rfi.rfi_variant_default');
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['asu_degree_rfi_a_of_i_optional'] = [
      ...
      '#description' => $this->t('Set area of interest as optional. Not
        usually recommended.'),
      '#default_value' => $config['asu_degree_rfi_a_of_i_optional'] ?? 0,
    ];
    ...
    $form['asu_degree_rfi_p_of_i_optional'] = [
      ...
      '#default_value' => $config['asu_degree_rfi_p_of_i_optional'] ?? 0,
    ];
