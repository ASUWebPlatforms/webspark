import * as AsuNews from '@asu/component-news';

(function ($, Drupal, drupalSettings) {
  Drupal.behaviors.asuNews = {
    attach: function (context, settings) {
      var componentLoaded =
        typeof AsuNews !== 'undefined' &&
        typeof AsuNews.initCardCarouselNewsComponent !== 'undefined';
      var newsExist =
        typeof settings.asu.components !== 'undefined' &&
        typeof settings.asu.components.asu_news !== 'undefined';
