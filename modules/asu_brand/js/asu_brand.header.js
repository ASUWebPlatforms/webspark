(function (Drupal, drupalSettings) {
      ...
      if (headerElement) {
        ...
        if (document.body.classList.contains('toolbar-fixed')) {
          headerElement.classList.add(
            'asu-brand-toolbar-header-tray-open-compat',
          );
        ...
        if (headerElement) {
          ...
          if (document.body.classList.contains('toolbar-tray-open')) {
            ...
            headerElement.classList.remove(
              'asu-brand-toolbar-header-tray-closed-compat' + vertSuffix,
            );
            headerElement.classList.remove(
              'asu-brand-toolbar-header-tray-closed-compat',
            );
            headerElement.classList.remove(
              'asu-brand-toolbar-header-tray-open-compat' + vertSuffix,
            );
            headerElement.classList.remove(
              'asu-brand-toolbar-header-tray-open-compat',
            );
            ...
            headerElement.classList.add(
              'asu-brand-toolbar-header-tray-open-compat' + classSuffix,
            );
          }
          // Set closed state class
            ...
            if (drupalSettings.is_admin) {
              // Set for current state.
              headerElement.classList.add(
                'asu-brand-toolbar-header-tray-closed-compat' + classSuffix,
              );
            }
          }
        }
  ...
  // Initialize the asu_brand component-header-footer header. The static SEO
  ...
  if (headerElement) {
    ...
    if (
      headerLoginElement &&
      (/\/cas[\/]?$/.test(headerLoginElement.href) ||
        /\/caslogin[\/]?$/.test(headerLoginElement.href))
    ) {
