...
## Re-add patches
Compare what you saved into a temporary text file with what exists in `custom-dependencies/patches.custom.json`. After making sure that the `custom-dependencies/patches.custom.json` file contains all of the patches unique to your site.
